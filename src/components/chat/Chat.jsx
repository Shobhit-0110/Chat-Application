...
const Chat = () => {
  ...
  }, [text]); // Add dependencies if needed
    ...
    <div className="chat">
      ...
      <div className="center">
        <div className="message">
          <img src="./avatar.png" alt="" />
          <div className="texts">
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis consequatur numquam at iste labore. Sit sequi quidem voluptatem fuga suscipit.</p>
            <span>1 min ago</span>
          </div>
        </div>
